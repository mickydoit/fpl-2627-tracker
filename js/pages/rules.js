...
setKids(app, 
  ...
  sectionOf('How the projections work', {},
    ...
    el('ul', {},
      ...
      el('li', {}, el('strong', {}, 'Last season — '), 'FPL wipes every season total at the GW1 deadline, which would leave the model with nothing to read until several gameweeks have been played. So 2025/26 — captured before the wipe — is pooled in, discounted to half the weight of a minute played this season. This season takes over on its own as it accumulates, drawing level around GW19. Rates and playing time are pooled; nothing else changes, and the minutes shown on the Players page are still this season’s alone.'),
      el('li', {}, el('strong', {}, 'Priors — '), 'players without enough minutes on record — counting this season plus the discounted 2025/26 — are blended toward a price-based prior, so a new signing from abroad is not projected at zero. One appearance is not mistaken for a season: a player with no history gets the confidence his few minutes deserve, however well he played in them. Those players are flagged in their breakdown.'),
    ),
